...
public class CourseGroupBusiness
{
    ...
    public int Insert(CourseGroup objCourseGroup)
    {
        ...
        return objData.DataInsertCourseGroup(objCourseGroup.ID, objCourseGroup.Year, objCourseGroup.Term, objCourseGroup.LevelCourse, objCourseGroup.Tuition, objCourseGroup.WeekPlan, objCourseGroup.ClassNumber, objCourseGroup.ID_FK_Teacher, objCourseGroup.ID_FK_Course);
    }
    ...
    {
        CourseGroupData objData = new CourseGroupData();
        return objData.DataUpdateCourseGroup(objCourseGroup.ID, objCourseGroup.Year, objCourseGroup.Term, objCourseGroup.LevelCourse, objCourseGroup.Tuition, objCourseGroup.WeekPlan, objCourseGroup.ClassNumber, objCourseGroup.ID_FK_Teacher, objCourseGroup.ID_FK_Course);
    }
