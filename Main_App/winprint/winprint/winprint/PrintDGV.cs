...
namespace winprint
{
    ...
    {
        // public static String StrImagePathArm;// for Arm ,Icon
        ...
        public static Font NewFont = null;             //Font
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                // Getting DataGridView object to printd
                ...
                for (int i = dgv.ColumnCount - 1; i >= 0; --i)
                {
                    ...
                    AvailableColumns.Add(dgv.Columns[i].HeaderText);
                    ...
                    System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                if (PrintOptions.report_flag == false)
                    ...
                    System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    CellHeight = GridRow.Height + AddCellHeight;
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            {
                                Image newImage = Image.FromFile("Arm.png");
                                // Draw image to screen.
                                e.Graphics.DrawImage(newImage, 100, 10, 90, 85);
                            }
                            if (System.IO.File.Exists("backgroundimage.png"))
                            {
                                Image newImage = Image.FromFile("backgroundimage.png");
                                newImage = (Image)ImageOpacity.ChangeOpacity(newImage, 0.2f);
                                // Draw image to screen.
                                e.Graphics.DrawImage(newImage, e.MarginBounds.Left, e.MarginBounds.Top, e.MarginBounds.Width, e.MarginBounds.Height);
                            }
                            //----------------set font 
                            if (System.IO.File.Exists("FontSetting.txt"))
                                NewFont = FontSetting.ReadFontFromText();
                            else
                                NewFont = dgv.Font;
                            //-----------------------------------------
                            e.Graphics.DrawString(PrintTitle, new Font(NewFont, FontStyle.Bold),
                                    Brushes.Black, (e.MarginBounds.Width) / 2 + PrintTitle.Length / 2, e.MarginBounds.Top -
                            e.Graphics.MeasureString(PrintTitle, new Font(NewFont,
                            ...
                            String s = FarsiGridView.GetPertionDate() + ": تاریخ "+ "\t\t";
                            s += DateTime.Now.ToShortTimeString() + " : ساعت " + Environment.NewLine ;
                            //DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToShortTimeString();

                            e.Graphics.DrawString(s, new Font(NewFont, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width -
                                    e.Graphics.MeasureString(s, new Font(NewFont,
                                    FontStyle.Bold), e.MarginBounds.Width).Width), e.MarginBounds.Top -
                                    e.Graphics.MeasureString(PrintTitle, new Font(new Font(NewFont,
                                    FontStyle.Bold), FontStyle.Bold), e.MarginBounds.Width).Height - 30);
                            ...
                            foreach (DataGridViewColumn GridCol in dgv.Columns)
                            {
                                ...
                                e.Graphics.DrawString(GridCol.HeaderText, NewFont,
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                                ...
                                ((Type)ColumnTypes[i]).Name == "DataGridViewLinkColumn")
                            {
                                ...
                                //e.Graphics.DrawString(Cel.Value.ToString(), NewFont,
                                ...
                                {
                                    e.Graphics.DrawString(string.Empty, NewFont ,
                                        new SolidBrush(Cel.InheritedStyle.ForeColor),
                                        new RectangleF((int)ColumnLefts[i], (float)tmpTop,
                                        (int)ColumnWidths[i], (float)CellHeight),StrFormat);
                                }
                    ...
                    int RowsPerPage)
        {
            ...
            e.Graphics.DrawString(PageNum, NewFont, Brushes.Black,
                e.MarginBounds.Left + (e.MarginBounds.Width -
                e.Graphics.MeasureString(PageNum, NewFont,
